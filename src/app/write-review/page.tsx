            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={6}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none resize-vertical"
              ...
              <div className="bg-yellow-50 rounded-xl p-6 border border-yellow-200">
                <div className="flex items-start">
                  <input
                    ...
                    onChange={handleInputChange}
                    className="mt-1 mr-3 w-5 h-5 text-yellow-600 focus:ring-yellow-500 border-gray-300 rounded"
                  />
                  <div className="flex-1">
                    <div className="flex items-center mb-2">
                      <Gift className="text-yellow-600 mr-2" size={20} />
