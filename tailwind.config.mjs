  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-purple-violet': 'linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%)',
        'gradient-emerald-teal': 'linear-gradient(135deg, #10b981 0%, #14b8a6 100%)',
        'gradient-violet-purple': 'linear-gradient(135deg, #7c3aed 0%, #6d28d9 100%)',
      },
    },
  },
  plugins: [],
